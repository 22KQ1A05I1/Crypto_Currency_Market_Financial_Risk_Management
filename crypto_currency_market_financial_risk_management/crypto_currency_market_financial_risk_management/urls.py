...
urlpatterns = [
    ...
    url(r'^predict_crypto_currency_financial_risk_type/$', remoteuser.predict_crypto_currency_financial_risk_type, name="predict_crypto_currency_financial_risk_type"),
    ...
    url(r'^Find_Crypto_Currency_Financial_Risk_Type_Ratio/$', serviceprovider.Find_Crypto_Currency_Financial_Risk_Type_Ratio, name="Find_Crypto_Currency_Financial_Risk_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Prediction_Crypto_Currency_Financial_Risk_Type/$', serviceprovider.View_Prediction_Crypto_Currency_Financial_Risk_Type, name="View_Prediction_Crypto_Currency_Financial_Risk_Type"),
